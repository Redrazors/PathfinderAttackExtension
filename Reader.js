...
import { array as array$$11, record, string, int32, union } from "./fable-library.2.3.5/Reflection";
import { SizeType, SizeType$reflection as SizeType$0024reflection } from "./Lib";
import { match, isMatch, replace, matches, split, create } from "./fable-library.2.3.5/RegExp";
import { parse } from "./fable-library.2.3.5/Int32";
import { delay, map as map$$1, rangeNumber } from "./fable-library.2.3.5/Seq";
import { append, concat, map, tryPick, reverse, fold, head, ofSeq } from "./fable-library.2.3.5/Array";
import { toText, printf, replace as replace$$1, isNullOrEmpty, trim } from "./fable-library.2.3.5/String";
import { isLetter, isNumber } from "./fable-library.2.3.5/Char";
export const AttackVariant = declare(function Reader_AttackVariant(tag, name, ...fields) {
  Union.call(this, tag, name, ...fields);
}, Union);
export function AttackVariant$reflection() {
  return union("Reader.AttackVariant", [], AttackVariant, () => ["Melee", "Ranged"]);
}
export const URLDamage = declare(function Reader_URLDamage(arg1, arg2, arg3, arg4) {
...
export function URLDamage$reflection() {
  return record("Reader.URLDamage", [], URLDamage, () => [["NumberOfDie", int32], ["Die", int32], ["BonusDamage", int32], ["DamageType", string]]);
}
export function createURLDamage(nOfDie, die, bonusDmg, damageType) {
  return new URLDamage(nOfDie, die, bonusDmg, damageType);
}
export const URLAttack = declare(function Reader_URLAttack(arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
...
export function URLAttack$reflection() {
  return record("Reader.URLAttack", [], URLAttack, () => [["AttackBonus", array$$11(int32)], ["WeaponName", string], ["WeaponDamage", URLDamage$reflection()], ["ExtraDamage", URLDamage$reflection()], ["CriticalRange", array$$11(int32)], ["CriticalModifier", int32], ["AdditionalEffects", string]]);
}
...
export const URLMonsterStats = declare(function Reader_URLMonsterStats(arg1, arg2, arg3, arg4, arg5) {
  this.BAB = arg1 | 0;
  this.Str = arg2 | 0;
  this.Dex = arg3 | 0;
  this.Feats = arg4;
...
export function URLMonsterStats$reflection() {
  return record("Reader.URLMonsterStats", [], URLMonsterStats, () => [["BAB", int32], ["Str", int32], ["Dex", int32], ["Feats", array$$11(string)], ["Size", SizeType$0024reflection()]]);
}
export function createURLMonsterStats(bab, str, dex, feats, size) {
  return new URLMonsterStats(bab, str, dex, feats, size);
}
export const URLMonsterAttacks = declare(function Reader_URLMonsterAttacks(arg1, arg2, arg3) {
  this.AttackType = arg1;
  this.AttackScheme = arg2;
  this.RelevantMonsterStats = arg3;
}, Record);
export function URLMonsterAttacks$reflection() {
  return record("Reader.URLMonsterAttacks", [], URLMonsterAttacks, () => [["AttackType", AttackVariant$reflection()], ["AttackScheme", array$$11(URLAttack$reflection())], ["RelevantMonsterStats", URLMonsterStats$reflection()]]);
}
...
function createAttackFromString(str$$2) {
  ...
  let patternInput;
  const splitAttackArr = attack.split(" ");
